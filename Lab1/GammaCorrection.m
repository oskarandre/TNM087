...
%
GImage = (OImage - lowgv)/(uppgv - lowgv); %contrst stretching

%% Gamma mapping of the previous result 
% Make sure that your image is in the range [0,1] before applying gamma
% correction!
%
GImage(GImage > 1) = 1; %Sätter alla värden större än 1 till 1
GImage(GImage < 0) = 0; %Sätter alla värden mindre än 0 till 0
