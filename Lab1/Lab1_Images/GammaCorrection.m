...
% handle input images of class uint8, uint16 and double 
OImage1 = im2double(OImage);
...
%
lowgv = quantile(OImage1(:),Lower) % Lower-bound gray value
uppgv = quantile(OImage1(:),Upper) % Upper-bound gray value
